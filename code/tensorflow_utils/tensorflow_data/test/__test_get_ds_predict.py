...
if __name__ == '__main__':
    """"""
    data_path = r'/Users/huayang/workspace/meituan/beauty_theme/data/data_test/20210129/imgs/待分类'
    batch_size = 16
    ds_predict, file_ls, file_name_ls = get_ds_predict_image(data_path, batch_size=batch_size)
    ds_image_show(ds_predict, file_name_ls, with_label=False, n_show=10, batch_size=batch_size)
